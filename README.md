 ...
 * @LastEditors: CK.Zh
 * @LastEditTime: 2021-01-24 13:05:20
...
| `画质` | 选择主控机侧展示的画面尺寸及比例 | 默认选择为 16:9 </br> 建议设置为与被控机相同的分辨率或画面比例 |
...
* “如何使被控机的声音通过主控机输出？”
    ...
    1. 设置`被控机`的音频输出为`HDMI`
    2. 确保所用HDMI线支持音频传输
    3. 取消`主控机`麦克风静音（部分笔记本可能具有类似功能），麦克风权限对VirtualKVM开放
